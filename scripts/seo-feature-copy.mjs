...
const pagesEnRaw = [
  {
    ...
    related: [['/en/tarot/cards', 'Browse all card meanings'], ['/en/guides/one-card-tarot', 'One-card asking guide'], ['/en/guides/three-card-spread', 'Three-card spread guide']],
  },
  {
    slug: 'horoscope',
  ...
  },
  {
    ...
    related: [['/en/guides/chinese-almanac-today', 'How to read today’s almanac'], ['/en/auspicious', 'Auspicious date finder'], ['/en/methodology', 'Methodology']],
  },
  {
    slug: 'cybermerit',
  ...
  },
  {
    ...
    related: [['/en/guides/bazi-calculator', 'BaZi calculator basics'], ['/en/ziwei', 'Zi Wei Dou Shu chart'], ['/en/methodology', 'Methodology']],
  },
  {
    slug: 'divination',
    ...
    related: [['/en/guides/fortune-stick-meaning', 'How to read a fortune stick'], ['/en/divination/sticks', 'Browse all stick readings'], ['/en/tarot', 'Free online tarot reading']],
  },
  {
    slug: 'dream',
  ...
  },
  {
    ...
    related: [['/en/guides/chinese-zodiac-compatibility', 'Zodiac compatibility guide'], ['/en/horoscope', 'Daily horoscope'], ['/en/nametest', 'Chinese name reading']],
  },
]
